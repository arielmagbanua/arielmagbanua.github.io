  ...
  data () {
    return {
      projects: [
        ...
        {
          title: 'Ariel and Phebe Wedding',
          description: 'The official wedding page of Ariel and Phebe. It has submit rsvp feature and map to where the wedding and reception will take place.',
